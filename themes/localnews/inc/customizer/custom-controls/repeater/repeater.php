 ...
 * @since 1.0.0
 */
class Local_News_WP_Custom_Repeater extends \WP_Customize_Control {
    /**
     ...
     * Main function
     * 
     * Local_News_WP_Custom_Repeater class name 
     */
    ...
    function enqueue() {
        ...
        wp_enqueue_style( 'local-news-wp-repeater', get_template_directory_uri() . '/inc/customizer/custom-controls/repeater/repeater.css', array(), LOCAL_NEWS_VERSION, 'all' );
        wp_enqueue_script( 'local-news-wp-repeater', get_template_directory_uri() . '/inc/customizer/custom-controls/repeater/repeater.js', array( 'jquery' ), LOCAL_NEWS_VERSION, true );
    }
    ...
    public function render_content() {
        ...
        $item_count = 1;
        ?>
        <div class="local-news-repeater-control">
            <label class="customize-control-title"><?php echo esc_html( $this->label ); ?></label>
            <?php if( $this->description ) { ?>
                <span class="description customize-control-description"><?php echo esc_html( $this->description ); ?></span>
            <?php } ?>
            <div class="local-news-repeater-control-inner">
                <?php 
                $row_label = $this->row_label;
                 foreach( $control_values as $control_value_key => $control_value ) :
                  ...
                  ?>
                    <div class="local-news-repeater-item <?php if( $control_value->item_option === 'show' ) : echo 'visible'; else : echo 'not-visible'; endif; ?>">
                        <div class="item-heading-wrap">
                            <span class="item-heading"><?php echo esc_html( $row_label ); ?></span>
                            <span class="settings-icon dashicons dashicons-admin-generic"></span>
                ...
                <div class="buttons-wrap">
                    <textarea class="repeater-control-value-holder" style="display:none;" <?php echo esc_attr( $this->link() ); ?>><?php echo json_encode( $control_values ); ?></textarea>
                </div>
            </div>
        </div>
        <?php
    ...
    function render_control( $field_key, $field, $current_item_value ) {
        $type = $field->type;
        $label = isset( $field->label ) ? $field->label : esc_html__( 'Item Label', 'localnews' );
        ...
        switch( $type ) {
            ...
            case 'image' : ?>
                <div class="single-control image-field">
                    ...
                    <div class="image-holder">
                            ...
                            <?php
                                if( $current_item_value->$field_key ) :
                                    if( wp_get_attachment_image_url( $current_item_value->$field_key ) ) :
                                        echo '<img src="' .esc_url(wp_get_attachment_image_url( $current_item_value->$field_key )). '">';
                                    endif;
                                else :
                                    echo '<img>';
                                endif;
                        ...
                        <div class="add-image-trigger <?php if( $current_item_value->$field_key ) echo 'no-trigger'; ?>"><?php echo esc_html__( 'Upload Image', 'localnews'); ?></div>
            ...
            <?php
                break;
            case 'fontawesome-icon-picker' : $icons_list = $this->get_all_fontawesome_icons(); ?>
                <div class="single-control fontawesome-icon-picker">
                    ...
                    <div class="icon-holder">
                        ...
                        <div class="icons-list" style="display:none;">
                            <input class="icon-search-input" type="text" placeholder="<?php echo esc_attr__( "Type to search", "localnews" ); ?>"/>
                            <?php
     ...
     * 
     */
    function get_all_fontawesome_icons() {
