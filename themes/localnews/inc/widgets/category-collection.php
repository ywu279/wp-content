<?php
/**
 * Adds Local_News_Category_Collection_Widget widget.
 * 
 * @package LocalNews
 * @since 1.0.0
 */
class Local_News_Category_Collection_Widget extends WP_Widget {
    /**
     * Register widget with WordPress.
     */
    public function __construct() {
        parent::__construct(
            'local_news_category_collection_widget',
            esc_html__( 'LN : Category Collection', 'localnews' ),
            array( 'description' => __( 'A collection of post categories.', 'localnews' ) )
        );
    }
    ...
    ?>
            <div class="categories-wrap layout-one">
                ...
                ?>
                        <div class="bmm-post-thumb post-thumb category-item cat-<?php echo esc_attr( $cat_id ); ?>">
                                        ...
                                        <?php
                                            ...
                                            echo '<span class="category-count">';
                                                ...
                                                <span class="news_text">
                                                    <?php echo esc_html__( 'News', 'localnews' ); ?>
                                                </span>
                                                    <?php
                                            echo '</span>';
                                        ?>
    ...
    function widget_fields() {
        ...
        return array(
                array(
                    ...
                    'default'   => esc_html__( 'Category Collection', 'localnews' )
                ),
                array(
                    'name'      => 'posts_categories',
                    'type'      => 'multicheckbox',
                    'title'     => esc_html__( 'Post Categories', 'localnews' ),
                    'description'=> esc_html__( 'Choose the categories to display', 'localnews' ),
...
} // class Local_News_Category_Collection_Widget