...
function local_news_widget_fields( $instance, $args, $field_value ) {
    echo '<div class="local-news-widget-field local-news-' .esc_html( $args['type'] ). '-field">';
        switch( $args['type'] ) {
            case 'number' : ?>
            ...
            case 'url' : ?>
                            ...
                            ?>
                            <input class="widefat" id="<?php echo $instance->get_field_id( $args['name'] ); ?>" name="<?php echo $instance->get_field_name( $args['name'] ); ?>" type="url" placeholder="<?php esc_attr_e( 'Add url here . .', 'localnews' ); ?>" value="<?php echo esc_url( $field_value ); ?>" />
                <?php
                break;
            case 'textarea' : ?>
                            <h2 class="title"><?php echo esc_html( $args['title'] ); ?></h2>
            ...
            case 'upload' : ?>
                            ...
                            <div class="upload-trigger<?php if( $field_value ) echo ' selected'; ?>">
                                <span><?php esc_html_e( 'Add image', 'localnews' ); ?></span>
                            </div>
                            <div class="upload-buttons<?php if( ! $field_value ) echo ' not-selected'; ?>">
                                ...
                                <button class="button button-link-delete remove-image"><?php esc_html_e( 'Remove image', 'localnews' ); ?></button>
                            </div>
                    ...
                    <div class="multicheckbox-content">
                        ...
                        ?>
                                <div class="multicheckbox-single-item">
                                    ...
                                    <label for="<?php echo $instance->get_field_name( $args['name'] ).'['.esc_attr($option_key).']'; ?>"><?php echo esc_html( $option_value ); ?></label>
                                </div>
                        <?php
                            endforeach;
                        ?>
        ...
        ?>
                ...
                <?php
                break;
            default : esc_html( 'Undefined control field', 'localnews' );
                break;
        }
    echo '</div>';
}
 ...
 * 
 */
function local_news_sanitize_widget_fields( $widget_field, $new_instance ) {
