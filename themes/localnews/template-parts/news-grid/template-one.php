...
extract( $args );
?>
<div class="news-grid <?php echo esc_attr( 'layout--' . $options->layout );?>">
    <?php
    ...
    <div class="news-grid-post-wrap">
        <?php
            ...
            if( $post_query -> have_posts() ) :
                ...
                ?>
                    <article class="grid-item <?php if(!has_post_thumbnail()){ echo esc_attr('no-feat-img');} ?>">
                        <figure class="post-thumb-wrap">
                            <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                <?php if( has_post_thumbnail() ) { 
                                        the_post_thumbnail('local-news-grid', array(
